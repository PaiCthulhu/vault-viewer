...
export const en: Record<string, string> = {
  ...
  'admin.vaults.buildAll': 'Build all',
  'admin.buildAll.title': 'Build all vaults',
  'admin.buildAll.intro': 'Build {count} vaults, one at a time.',
  'admin.buildAll.confirm': 'Confirm',
  'admin.buildAll.building': 'Building…',
  'admin.buildAll.close': 'Close',
  'admin.buildAll.summary': '{ok} ok, {error} with errors.',
  'admin.buildAll.unloadWarning': 'A build is in progress. Leaving now will interrupt it.',
  'admin.buildAll.statusPending': 'Pending',
  'admin.buildAll.statusBuilding': 'Building…',
  'admin.buildAll.statusOk': 'OK',
  'admin.buildAll.statusError': 'Error',
  'admin.buildAll.errNetwork': 'Network error',

...
export const ptBR: Record<string, string> = {
  ...
  'admin.vaults.buildAll': 'Gerar build de todos',
  'admin.buildAll.title': 'Gerar build de todos os vaults',
  'admin.buildAll.intro': 'Buildar {count} vaults, um de cada vez.',
  'admin.buildAll.confirm': 'Confirmar',
  'admin.buildAll.building': 'Buildando…',
  'admin.buildAll.close': 'Fechar',
  'admin.buildAll.summary': '{ok} ok, {error} com erro.',
  'admin.buildAll.unloadWarning': 'O build está em andamento. Se sair agora, a operação será interrompida.',
  'admin.buildAll.statusPending': 'Pendente',
  'admin.buildAll.statusBuilding': 'Buildando…',
  'admin.buildAll.statusOk': 'OK',
  'admin.buildAll.statusError': 'Erro',
  'admin.buildAll.errNetwork': 'Erro de rede',
